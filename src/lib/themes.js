...
export const THEMES = {
  ...
  panda: {
    '--c-primary':            '#111111',  // dark — components hardcode #fff text on primary bg
    '--c-primary-2':          '#222222',
    '--c-accent':             '#ffffff',
    '--c-accent-light':       '#0a0a0a',
    ...
    '--c-danger':             '#d5d5d5',
    '--c-danger-bg':          '#0a0a0a',
    '--c-danger-light':       '#424242',
    '--c-success':            '#e0e0e0',
    '--c-success-light':      '#0a0a0a',
    '--c-warning':            '#888888',
    '--c-warning-bg':         '#050505',
    '--c-warning-text':       '#cccccc',
    '--c-chip-bg':            '#1a1a1a',
    '--c-chip-text':          '#ffffff',
    ...
    '--c-shadow':             '0 2px 8px rgba(0,0,0,0.4)',
  },
