...
/** Expandable category breakdown for LogView */
          ...
          {categories.map(({ category, amount, pct }) => (
            <div key={category}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
                ...
                <p style={{ fontSize: 13, fontWeight: 800, color: 'var(--c-text, #1c1917)', margin: 0 }}>{fmt(amount)} <span style={{ color: 'var(--c-muted, #9ca3af)', fontWeight: 600 }}>({pct}%)</span></p>
              </div>
