...
const inputStyle = {
  ...
  fontSize: 14, fontWeight: 600, outline: 'none', background: '#f9fafb',
  fontFamily: "'Nunito', sans-serif", color: '#1c1917', boxSizing: 'border-box',
};
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        {categories.map(cat => (
          <div key={cat.id} style={{ display: 'flex', alignItems: 'center', gap: 8, background: '#f9fafb', borderRadius: 12, padding: '10px 12px' }}>
            ...
            <button
              ...
              style={{ background: '#fee2e2', border: 'none', borderRadius: 8, padding: '6px 10px', fontSize: 12, fontWeight: 800, color: '#dc2626', cursor: 'pointer', flexShrink: 0 }}
            >
              ✕
            </button>
          </div>
      ...
      <button
        onClick={addCategory}
        style={{ width: '100%', padding: '11px', borderRadius: 12, border: '2px dashed #059669', background: 'transparent', color: '#059669', fontSize: 13, fontWeight: 800, cursor: 'pointer', fontFamily: "'Nunito', sans-serif" }}
      >
        + Add category
      </button>
